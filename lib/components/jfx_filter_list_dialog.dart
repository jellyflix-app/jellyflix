...
class JfxFilterListDialog {
  static show<T extends Object>(context,
    ...
    return await FilterListDialog.display<T>(
      context,
      ...
      choiceChipLabel: (item) {
        if (item is ItemFilter) {
          ...
          throw ArgumentError('Item must be of type FilterType or BaseItemDto');
        }
      },

...
import 'package:jellyflix/providers/pagestorage_provider.dart';
...
class HomeScreen extends HookConsumerWidget {
  ...
  final PageStorageKey myWidgetKey = const PageStorageKey('MyUniqueWidgetKey');

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      body: PageStorage(
        bucket: ref.read(pageStorageProvider),
